...
export const metadata: Metadata = {
  ...
  description:
    "How OpusGen AI collects, uses, and protects your personal information.",
};
...
function Section({
  ...
  return (
    <section className="mb-10">
      <h2
        className="text-lg font-black tracking-tight mb-4 pb-3"
        style={{
...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="mb-12">
        <span
          className="text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-5 inline-block"
          style={{
            background: S.redBg,
      ...
      {/* Intro box */}
      <div
        className="p-5 rounded-2xl mb-12 text-sm leading-relaxed"
        style={{
          background: S.glass,
      ...
      >
        ...
        and our AI-powered product photography platform (collectively, the
        &quot;Service&quot;). Please read this policy carefully. By using the
      ...
      <Section title="1. Information We Collect">
        ...
        <UL
          items={[
            ...
            "Payment information: We use Polar (Polar Software Inc.) as our Merchant of Record and payment processor. When you subscribe to a paid plan, your payment information (such as credit card details, billing address, and tax information) is collected and processed directly by Polar in compliance with PCI-DSS requirements. OpusGen AI never collects, stores, or has access to your full credit card numbers or payment credentials. We only receive non-sensitive transaction tokens, subscription identifiers, and status updates.",
      ...
      <Section title="2. How We Use Your Information">
        ...
        <UL
          items={[
            ...
            "To manage your credit balance, process subscription billing, and deliver paid tier features via Polar.",
        ...
        <P>
          ...
          We do <em>not</em> use your uploaded images or generated outputs to
          train our AI models without your explicit opt-in consent. Your
          creative content belongs to you.
        </P>
      </Section>
      ...
      <Section title="3. How We Share Your Information">
        ...
        <UL
          items={[
            "Service providers: trusted third parties who assist in operating our platform — Polar Software Inc. (Merchant of Record and payment processor handling subscription billing, tax compliance, invoicing, and customer billing portal), Supabase (database, authentication, and file storage), Vercel (hosting and cookie-free web analytics), and Resend (transactional email delivery). These providers are contractually bound to protect your data.",
      ...
      <Section title="5. Cookies and Tracking Technologies">
        ...
        <P>
          See our{" "}
          <a href="/cookie-policy" style={{ color: S.red }}>
            Cookie Policy
          </a>{" "}
          for the full list of cookies we use. You can manage cookies through
          your browser settings; note that disabling essential cookies will
          prevent you from using core features of the Service.
        </P>
      </Section>
      ...
      <Section title="6. Your Privacy Rights">
        ...
        <P>
          ...
          <strong style={{ color: S.red }}>privacy@opusgenai.com</strong>. We
          will respond within 30 days (or as required by applicable law). EU/UK
          residents may also lodge a complaint with their local data protection
          authority.
        </P>
      </Section>
      ...
      <Section title="7. International Data Transfers">
        <P>
          OpusGen AI is based in the United States. If you access our Service
          from outside the U.S., your information may be transferred to, stored,
        ...
        <P>
          ...
          Switzerland, we implement appropriate safeguards for international
          transfers, including Standard Contractual Clauses (SCCs) approved by
      ...
      <Section title="8. Security">
        ...
        />
        <P>
          Despite these measures, no security system is impenetrable. In the
          event of a data breach that poses a risk to your rights, we will
      ...
      <Section title="9. Children's Privacy">
        <P>
          Our Service is not directed at children under the age of 13 (or 16 in
          ...
          <strong style={{ color: S.red }}>privacy@opusgenai.com</strong> and we
          will delete such information promptly.
        </P>
      </Section>
      ...
      <Section title="11. Changes to This Policy">
        <P>
          ...
          with a new &quot;Last Updated&quot; date, and by sending an email
          notification to registered users at least 14 days before changes take
          effect.
        </P>
        <P>
      ...
      <Section title="12. Contact Us">
        ...
        <div
          ...
          style={{ background: S.glass, border: `1px solid ${S.border}` }}
        >
          <p
          ...
          <p style={{ color: S.muted }}>
            Email:{" "}
            <a href="mailto:privacy@opusgenai.com" style={{ color: S.red }}>
              privacy@opusgenai.com
            </a>
          </p>
          <p style={{ color: S.muted }}>
            Data Protection Officer:{" "}
            <a href="mailto:dpo@opusgenai.com" style={{ color: S.red }}>
              dpo@opusgenai.com
            </a>
          </p>
          <p className="mt-2" style={{ color: S.muted }}>
