    ...
    >
      ...
      <div className="relative rounded-3xl overflow-hidden" style={{ padding: "1.5px" }}>
        ...
        <div
          ...
          style={{ background: "rgba(180,18,18,0.32)" }}
        />
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full flex items-center justify-center gap-3 h-12 rounded-2xl font-semibold text-sm transition-all mb-5"
            style={{
              border: "1px solid rgba(255,255,255,0.1)",
              background: "rgba(255,255,255,0.04)",
              color: "rgba(255,255,255,0.82)",
            }}
            onClick={() => { setGoogleLoading(true); setTimeout(() => setGoogleLoading(false), 1500); }}
          ...
          <div className="relative mb-5">
            ...
            <span
              ...
              style={{ background: "#0d0303", color: "rgba(255,255,255,0.32)" }}
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-12 rounded-2xl px-4 text-sm outline-none transition-all placeholder:opacity-30"
                style={inputStyle}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  minLength={8}
                  className="w-full h-12 rounded-2xl px-4 pr-12 text-sm outline-none transition-all placeholder:opacity-30"
                  style={inputStyle}
                  onFocus={(e) => { e.currentTarget.style.borderColor = "rgba(220,38,38,0.65)"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(220,38,38,0.1)"; }}
                  onBlur={(e) => { e.currentTarget.style.borderColor = "rgba(255,255,255,0.1)"; e.currentTarget.style.boxShadow = "none"; }}
                  required
            ...
            >
              ...
              {/* Text */}
              <p className="text-xs leading-relaxed select-none" style={{ color: "rgba(255,255,255,0.42)" }}>
                ...
                <Link
                  ...
                  style={{ color: "#f87171", textDecorationColor: "rgba(248,113,113,0.35)" }}
              ...
              {loading ? (
                ...
                <>
                  ...
                  <span
                    ...
                    style={{ background: agreed ? "rgba(255,255,255,0.18)" : "rgba(255,255,255,0.08)" }}
                  >
