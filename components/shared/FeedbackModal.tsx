    ...
    <>
      ...
      {variant === "icon" && (
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.color = W.text;
            e.currentTarget.style.background = W.glassMid;
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.color = W.muted;
...
function FeedbackModal({ onClose }: { onClose: () => void }) {
  ...
  const canSubmit =
    message.trim().length > 0 && rating > 0 && category !== null;
          ...
          {submitted ? (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-sm" style={{ color: W.muted }}>
                  Your feedback helps us improve OpusGen AI.
                </p>
              </div>
            </motion.div>
          ) : (
              ...
              <div className="flex items-center gap-3 pr-8">
                ...
                <div>
                  ...
                  <p className="text-xs" style={{ color: W.muted }}>
                    Help us make OpusGen AI better
                  </p>
                </div>
              </div>
