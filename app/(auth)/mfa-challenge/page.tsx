...
function MfaChallengeForm() {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (error || !data) {
        toast.error("Couldn't load your security factors.");
        setReady(true);
        return;
      }
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              whileHover={{
                scale: 1.02,
                boxShadow: "0 0 48px rgba(220,38,38,0.5)",
              }}
              whileTap={{ scale: 0.97 }}
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 mt-5 text-xs font-medium transition-opacity hover:opacity-80 disabled:opacity-50 disabled:cursor-wait"
